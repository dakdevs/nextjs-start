...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        'mb-1.5 font-medium data-[variant=label]:text-ui data-[variant=legend]:text-body',
        className,
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-left text-ui leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5',
